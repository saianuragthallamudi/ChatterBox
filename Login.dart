                  ...
                  child: Column(
                    children: [
                      ...
                      controller: passController,
                        validator: (val) {return val.length < 6 ? "Enter Password 6+ characters" : null;},
                      ),
                    ],
                  ),
                ),
              ...
              TextCard(
                ...
                onTap: () async {
                  ...
                  try {
                    ...
                    if (newUser != null) {
                      final userinfo =await Firestore.instance.collection("users").where("mail", isEqualTo:emailController.text ) .getDocuments();

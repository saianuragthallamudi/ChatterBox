...
//                      ),
                    Card(
                      elevation: 15.0,
                      child: ListTile(
                        leading: Text('Mail',style: TextStyle(color:Colors.black38,fontSize: 15,fontWeight:FontWeight.w300),),
                        title: Container(
                    ...
                    Card(
                      elevation: 15.0,
                      child: ListTile(
                        leading: Text('NickName',style: TextStyle(color:Colors.black38,fontSize: 15,fontWeight:FontWeight.w300),),
                        title: Container(
                    ...
                    Card(
                      elevation: 15.0,
                      child: ListTile(
                        leading: Text('Bio',style: TextStyle(color:Colors.black38,fontSize: 15,fontWeight:FontWeight.w300),),
                        title: Container(
                          padding: EdgeInsets.fromLTRB(35, 0, 0, 0),
                          child: Text(bio,
                            style: TextStyle(
